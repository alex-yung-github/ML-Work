...
image_to_change = Image.open("C:/Users/super/All CS Work/ML Class Work/8 Neural Style Transfer/images/blahaj.jpg")
newImage = resize_image(image_to_change, 256)
newImage.save("images/created.jpg")